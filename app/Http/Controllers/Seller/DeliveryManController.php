...
class DeliveryManController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $dm->NameCoordinates = $request->NameCoordinates;
        $dm->coordinates = $request->coordinates;
    ...
    {
        //$zone = DeliveryMan::selectRaw("*,ST_AsText(ST_Centroid(`coordinates`)) as center")->findOrFail($id);
    ...
    public function update(Request $request, $id)
    {
        ...
        $delivery_man->NameCoordinates = $request->NameCoordinates;
        $delivery_man->coordinates = $request->coordinates;

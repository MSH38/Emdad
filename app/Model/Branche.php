...
class Branche extends Model 
{
    ...
    protected $fillable = ['branche_name','store_id', 'user_id', 'city_id','state_id', 'country_id','seller_id','shop_id','branche_address','phone_home','phone_mobile','manager_name', 'menager_password','email', 'branche_info', 'identity_number', 'identity_type', 'identity_image' , 'is_active' ];

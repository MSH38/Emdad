                ...
                <div class="card">
                    <div class="card-header">
                        {{-- <div class="row justify-content-between pl-4 pr-4">
                            <div>
                                <h5>{{\App\CPU\translate('new req ordert')}}</h5>
                            </div>
                            <div>
                                <!-- Modal -->
                        ...
                        <div class="flex-between row justify-content-between align-items-center flex-grow-1 mx-1">
                            <div class="flex-start">
                                <div><h5>{{\App\CPU\translate('new req ordert')}}</h5></div>
                                <div class="mx-1"><h5 style="color: red;">({{ $reqorders->total() }})</h5></div>
                            </div>
                    ...
                    <div class="card-body" style="padding: 0">
                        <div class="table-responsive">
                            <table id="datatable"
                                ...
                                ?>
                                <tbody>
                                @foreach($reqorders as $key =>$ticket)
                                    <tr class="text-center">
                                        <td>{{$reqorders->firstItem()+$key}}</td>
                                        ...
                                        <td>
                                            <a href="{{route('admin.new-req-order.singleNewReqOrder',$ticket['id'])}}"
            ...
            <!-- Page level plugins -->
                ...
                <script>
                    $(document).on('change', '.status', function () {
                        ...
                        $.ajax({
                            url: "{{route('admin.new-req-order.status')}}",
                            method: 'POST',
                            data: {
                                id: id,
                                status: status

        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('admin.categoriesdep.store')}}" method="post">
                            @csrf
                        ...
                        <div class="row justify-content-between align-items-center flex-grow-1">
                            <div class="col-lg-3 mb-3 mb-lg-0">
                                <div class="flex-start">
                                    ...
                                    <div class="mx-1"><h5 style="color: red;">(hhhhhhh)</h5></div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <!-- Search -->
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table
                                ...
                                <tbody>
                                @foreach($categorydep as $key =>$data)
                                    <tr class="text-center">

                            ...
                            <div class="card-body" style="padding: 20px">
                                <center>
                                    <img height="200" style="width: 100%" id="viewerShop"
                                         ...
                                         src="{{asset('storage/public/shop')}}/{{\App\CPU\Helpers::get_business_settings('shop_banner')}}">
                                </center>
                                <hr>
                            ...
                            <div class="card-body" style="padding: 20px">
                                <center>
                                    <img width="200" height="60" id="viewerWL"
                                         onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                                         src="{{asset('storage/public/company')}}/{{\App\Model\BusinessSetting::where(['type' => 'company_web_logo'])->pluck('value')[0]}}">
                                </center>
                                <hr>
                                <div class="row pl-4 pr-4">
                                    <div class="col-12" style="text-align: left">
                            ...
                            <div class="card-body" style="padding: 20px">
                                <center>
                                    <img width="100" height="60" id="viewerML"
                                         onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                                         src="{{asset('storage/public/company')}}/{{\App\Model\BusinessSetting::where(['type' => 'company_mobile_logo'])->pluck('value')[0]}}">
                                </center>
                                <hr>
                                <div class="row pl-4 pr-4">
                                    <div class="col-12" style="text-align: left">
                            ...
                            <div class="card-body" style="padding: 20px;height:180px;">
                                <center>
                                    <img width="60" id="viewerWFL"
                                        onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                                        src="{{asset('storage/public/company')}}/{{\App\Model\BusinessSetting::where(['type' => 'company_footer_logo'])->pluck('value')[0]}}">
                                </center>
                                <hr>
                                <div class="row pl-4 pr-4">
                                    <div class="col-12" style="text-align: left">
                            ...
                            <div class="card-body" style="padding: 20px;height:180px;">
                                <center>
                                    <img width="60" id="viewerFI"
                                         onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                                         src="{{asset('storage/public/company')}}/{{\App\Model\BusinessSetting::where(['type' => 'company_fav_icon'])->pluck('value')[0]}}">
                                </center>
                                <hr>
                                <div class="row pl-4 pr-4">
                                    <div class="col-12" style="text-align: left">
                            ...
                            <div class="card-body" style="padding: 20px;height:180px;">
                                <center>
                                    <img width="60" id="viewerLoader"
                                         onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                                         src="{{asset('storage/public/company')}}/{{\App\CPU\Helpers::get_business_settings('loader_gif')}}">
                                </center>
                                <hr>
                                <div class="row pl-4 pr-4">
                                    <div class="col-12" style="text-align: left">

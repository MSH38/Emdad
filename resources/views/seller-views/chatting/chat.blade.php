                                ...
                                @foreach($chattings_user as $key => $chatting)
                                    <div class="chat_list @if ($key == 0) active @endif"
                                        ...
                                        <div class="chat_people" id="chat_people">
                                            <div class="chat_img">
                                                <img src="{{asset('storage/public/profile/'.$chatting->image)}}"
                                                ...
                                                <div class="incoming_msg">
                                                    <div class="incoming_msg_img">
                                                        <img style="width: 30px;height: 30px;border-radius: 50%"
                                                             src="{{asset('storage/public/profile/'.$message->image)}}"
                                                             onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                                                             alt="">
                                                    </div>
                ...
                $.ajax({
                  ...
                  <div class="incoming_msg" id="incoming_msg">
                    <div class="incoming_msg_img" id="">
                      <img src="${window.location.origin}/storage/public/profile/${element.image}" style="border-radius: 10px;" alt="">
                    </div>
                    <div class="received_msg">
                      <div class="received_withd_msg">

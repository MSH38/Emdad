                            ...
                            <div class="row">
                                <div class="col-md-12 col-12">
                                    <div class="form-group p-0 m-0">
                                        <label style="font-size: 1.3rem" class="input-label fw-bolder" for="regiseration_number"> {{\App\CPU\translate('regiseration_number')}}</label>
                                        <input type="text" name="regiseration_number" class="form-control" placeholder="{{\App\CPU\translate('regiseration_number')}}"
                                                required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group p-0 m-0">
                                        ...
                                        <input type="text" name="start_date" class="form-control" placeholder="{{\App\CPU\translate('start_date')}}" id="start_date" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group p-0 m-0">
                                        ...
                                        <input type="text" name="end_date" class="form-control" placeholder="{{\App\CPU\translate('end_date')}}" id="end_date" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 col-12">
                                    <div class="form-group p-0 m-0">
                                        ...
                                        <input type="file" name="regist_image" class="form-control" id="regist_image" required>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-12">
                                    <div class="form-group p-0 m-0">
                                        ...
                                        <input type="number" name="certificate_number" class="form-control" placeholder="{{\App\CPU\translate('certificate_number')}}" id="certificate_number" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 col-12">
                                    <div class="form-group p-0 m-0">
                                        ...
                                        <input type="file" name="certificate_image" class="form-control" id="certificate_image" required>
                                    </div>
                                </div>

                ...
                <div class="" style="height:80vh ; overflow-y:scroll;  overflow-x: hidden;">
                    <div class="card-body p-0 " style=" margin:0 80px ;">
                        ...
                        <form class="needs-validation digit-group mt-4" data-group-name="digits" data-autosubmit="false"
                            autocomplete="off"  action="{{ route('customer.auth.login') }}"
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group p-0 m-0">
                                        <label style="font-size: 1.3rem" class="input-label fw-bolder" for="exampleFormControlInput1"> {{\App\CPU\translate('company_name')}} (عربيـ)</label>
                                        <input type="text" name="company_name_en" class="form-control" placeholder="{{\App\CPU\translate('company_name')}}"
                                                required>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group p-0 m-0">
                                        <label style="font-size: 1.3rem" class="input-label fw-bolder" for="exampleFormControlInput1">{{\App\CPU\translate('company_name')}} (en) </label>
                                        <input type="text" name="company_name_ar" class="form-control" placeholder="{{\App\CPU\translate('company_name')}}"
                                                required>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-12">
                                <div class="form-group p-0 m-0">
                                    <label class="input-label fw-bolder " style="font-size: 1.3rem" for="exampleFormControlInput1">{{\App\CPU\translate('company type')}}</label>
                            ...
                            <div class="col-md-12 col-12">
                                <div class="form-group p-0 m-0">
                                    <label class="input-label fw-bolder " style="font-size: 1.3rem" for="exampleFormControlInput1">{{\App\CPU\translate('country')}}</label>
                            ...
                            <div class="col-md-12 col-12">
                                <div class="form-group p-0 m-0">
                                    <label class="input-label fw-bolder " style="font-size: 1.3rem" for="exampleFormControlInput1">{{\App\CPU\translate('city')}}</label>
                                    <select
                                    class="js-example-basic-multiple form-control"
                                    name="city_id"
                                    onchange="getRequest('{{url('/')}}/seller/auth/get-places?city_id='+this.value,'choice_attributes','select')"
                                    required>
                            ...
                            <div class="col-md-12 col-12">
                                <div class="form-group p-0 m-0">
                                    <label class="input-label fw-bolder js-example-responsive" style="font-size: 1.3rem" for="choice_attributes">{{\App\CPU\translate('places')}}</label>
                                    <select

    ...
    <div class="content container-fluid">
        ...
        <div class="page-header pb-0" style="border-bottom: 0!important">
            <div class="flex-between row align-items-center mx-1">
                ...
                <div>
                    <a class="btn btn-primary" href="{{route('seller.product.list')}}" style="border:none;background: linear-gradient(to right, #a093c5 0%, #645cb3 100%)">
        ...
        <div class="card" style="background: linear-gradient(to right, #a093c5 0%, #645cb3 100%)">
            <div class="card-body">
                <h1 class="text-light">صباح الخير,{{auth('seller')->user()->f_name}} {{auth('seller')->user()->l_name}}</h1>
                <div class="d-flex justify-content-between">
                    <h3 class="text-light">لديك {{ $data['today_order'] }} طلبات جديدة</h3>
                    <a href="{{url('seller/orders/list/all')}}" class="btn btn-primary" style="background: linear-gradient(to right, #93c5a2  0%, #5cb384 100%);border:none">{{\App\CPU\translate('Orders')}} <i class="fa fa-arrow-left"></i></a>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-4 col-12 mt-3">
                <div class="card">
                    <div class="card-body">
                        <div class="card">
                            <div class="card-body">
                                <h3 class="text-muted">{{\App\CPU\translate('Today Amount')}}</h3>
                                <h1>{{number_format($todayAmount)}} ريال</h1>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <h3 class="text-muted">{{\App\CPU\translate('Sum Orders')}}</h3>
                                <h1>{{number_format($data['collected_cash'])}} ريال</h1>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <h3 class="text-muted">{{\App\CPU\translate('Number of Customers')}}</h3>
                                <h1>{{number_format(count($customers))}} {{\App\CPU\translate('customer')}}</h1>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row gx-2 gx-lg-3">
            ...
            <div class="col-lg-6 mt-3">
                <!-- Card -->
                <div class="card h-100">
                    @include('seller-views.partials._last-orders',['orders'=>$data['last_orders']])
                </div>
                <!-- End Card -->
            </div>

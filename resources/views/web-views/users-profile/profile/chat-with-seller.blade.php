                                                ...
                                                @if ($chat->sent_by_seller)
                                                    <div class="incoming_msg">
                                                        <div class="incoming_msg_img"><img
                                                                src="@if($chat->image == 'def.png'){{asset('storage/public/'.$chat->image)}} @else {{asset('storage/public/shop/'.$chat->image)}} @endif"
                                                                alt="sunil"></div>
                    ...
                    <div class="outgoing_msg">
                      <div class='send_msg'>
                        ...
                        <span class='time_date'> ${time}    |    ${date}</span>
                                    ...
                                    let img_path = element.image == 'def.png' ? `${window.location.origin}/storage/public/${element.image}` : `${window.location.origin}/storage/public/shop/${element.image}`;

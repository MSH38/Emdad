...
@push('css_or_js')
    ...
    @if($product['meta_image']!=null)
        <meta property="og:image" content="{{asset("storage/public/product/meta")}}/{{$product->meta_image}}"/>
        <meta property="twitter:card"
              content="{{asset("storage/public/product/meta")}}/{{$product->meta_image}}"/>
    @else
        <meta property="og:image" content="{{asset("storage/public/product/thumbnail")}}/{{$product->thumbnail}}"/>
        <meta property="twitter:card"
              content="{{asset("storage/public/product/thumbnail/")}}/{{$product->thumbnail}}"/>
    @endif
                                    ...
                                    @foreach (json_decode($product->images) as $key => $photo)
                                        <div
                                            ...
                                            <img class="cz-image-zoom img-responsive" style="width:100%;height:auto"
                                                ...
                                                src="{{asset("storage/public/product/$photo")}}"
                                                data-zoom="{{asset("storage/public/product/$photo")}}"
                                    ...
                                    <div class="row d-flex ">
                                        <div>
                                            <img style="height: 65px; width: 65px; border-radius: 50%"
                                                src="{{asset('storage/public/shop')}}/{{$product->seller->shop->image}}"
                                                onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                                                alt="">
                                        </div>

...
@push('css_or_js')
    @if($shop['id'] != 0)
        <meta property="og:image" content="{{asset('storage/public/shop')}}/{{$shop->image}}"/>
        <meta property="og:title" content="{{ $shop->name}} "/>
        <meta property="og:url" content="{{route('shopView',[$shop['id']])}}">
    @else
        <meta property="og:image" content="{{asset('storage/public/company')}}/{{$web_config['fav_icon']->value}}"/>
        <meta property="og:title" content="{{ $shop['name']}} "/>
        <meta property="og:url" content="{{route('shopView',[$shop['id']])}}">
    @endif
    ...
    @if($shop['id'] != 0)
        <meta property="twitter:card" content="{{asset('storage/public/shop')}}/{{$shop->image}}"/>
        <meta property="twitter:title" content="{{route('shopView',[$shop['id']])}}"/>
        <meta property="twitter:url" content="{{route('shopView',[$shop['id']])}}">
    @else
        <meta property="twitter:card"
              content="{{asset('storage/public/company')}}/{{$web_config['fav_icon']->value}}"/>
        <meta property="twitter:title" content="{{route('shopView',[$shop['id']])}}"/>
        <meta property="twitter:url" content="{{route('shopView',[$shop['id']])}}">
    @endif
                ...
                <div style="background: white">
                    @if($shop['id'] != 0)
                        <img style="width:100%; height: auto; max-height: 13.75rem; border-radius: 10px;"
                             src="{{asset('storage/public/shop/banner')}}/{{$shop->banner}}"
                             onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                             alt="">
                    @else
                        @php($banner=\App\CPU\Helpers::get_business_settings('shop_banner'))
                        <img style="width:100%; height: auto; max-height: 13.75rem; border-radius: 10px;"
                             src="{{asset("storage/public/shop")}}/{{$banner??""}}"
                             onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                             alt="">
                    @endif
                </div>
                            ...
                            <div class="">
                                @if($shop['id'] != 0)
                                    <img style="max-height: 115px;width:120px; border-radius: 5px;"
                                         src="{{asset('storage/public/shop')}}/{{$shop->image}}"
                                         onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                                         alt="">
                                @else
                                    <img style="height: 120px;width:120px; border-radius: 5px;"
                                         src="{{asset('storage/public/company')}}/{{$web_config['fav_icon']->value}}"
                                         onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                                         alt="">
                                @endif
                            </div>
                                        ...
                                        <div class="card" style="border-bottom: 2px solid #EEF6FF;background:none !important; ">
                                            ...
                                            <div class="card-header p-1 flex-between" >
                                                <div class="d-flex ">
                                                    ...
                                                    onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                                                    src="{{asset('storage/public/category')}}/{{$category['icon']}}">

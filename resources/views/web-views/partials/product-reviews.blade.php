        ...
        <div
            ...
            <div
                ...
                <img style="max-height: 64px;"
                    ...
                    src="{{asset("storage/public/profile")}}/{{(isset($productReview->user)?$productReview->user->image:'')}}"
            ...
            @if (!empty(json_decode($productReview->attachment)))
                @foreach (json_decode($productReview->attachment) as $key => $photo)
                    <img
                        ...
                        onclick="showInstaImage('{{asset("storage/public/review/$photo")}}')"
                        class="cz-image-zoom"
                        onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                        src="{{asset("storage/public/review/$photo")}}"

...
Route::group(['namespace' => 'Web','middleware'=>['maintenance_mode']], function () {
    ...
    Route::group(['prefix' => 'new-req-order', 'as' => 'new-req-order.'], function () {
        Route::get('{id}', 'UserProfileController@single_new_req_order')->name('index');
        Route::post('{id}', 'UserProfileController@new_req_order_submit')->name('comment');
        Route::get('delete/{id}', 'UserProfileController@new_req_order_delete')->name('delete');
        Route::get('close/{id}', 'UserProfileController@new_req_order_close')->name('close');
    });

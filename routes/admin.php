...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'new-req-order', 'as' => 'new-req-order.','middleware'=>['module:support_section']], function () {
            Route::get('view', 'NewReqOrderController@index')->name('view');
            Route::post('status', 'NewReqOrderController@status')->name('status');
            Route::get('single-neworder/{id}', 'NewReqOrderController@single_new_req_order')->name('singleNewReqOrder');
            Route::post('single-neworder/{id}', 'NewReqOrderController@replay_submit')->name('replay');
        });
        ...
        Route::group(['prefix' => 'customer', 'as' => 'customer.','middleware'=>['module:user_section']], function () {
            ...
            Route::post('isdoc-update', 'CustomerController@isdoc_update')->name('isdoc-update');
            ...
            Route::get('jobnames/index', 'JobNameController@index')->name('jobnamesindex');
            Route::get('jobnames/edit/{id}', 'JobNameController@edit')->name('jobnames.edit');
            Route::get('jobnames/destroy/{id}', 'JobNameController@destroy')->name('jobnames.destroy');
            Route::post('jobnames/featured', 'JobNameController@updateFeatured')->name('jobnames.featured');
            Route::post('jobnames/active', 'JobNameController@updateActive')->name('jobnames.active');

            Route::get('departmenttyps/index', 'DepartmentTypController@index')->name('departmenttypsindex');
            Route::get('departmenttyps/edit/{id}', 'DepartmentTypController@edit')->name('departmenttyps.edit');
            Route::get('departmenttyps/destroy/{id}', 'DepartmentTypController@destroy')->name('departmenttyps.destroy');
            Route::post('departmenttyps/featured', 'DepartmentTypController@updateFeatured')->name('departmenttyps.featured');
            Route::post('departmenttyps/active', 'DepartmentTypController@updateActive')->name('departmenttyps.active');

            Route::get('saletyps/index', 'SaleTypController@index')->name('saletypsindex');
            Route::get('saletyps/edit/{id}', 'SaleTypController@edit')->name('saletyps.edit');
            Route::get('saletyps/destroy/{id}', 'SaleTypController@destroy')->name('saletyps.destroy');
            Route::post('saletyps/featured', 'SaleTypController@updateFeatured')->name('saletyps.featured');
            Route::post('saletyps/active', 'SaleTypController@updateActive')->name('saletyps.active');

            Route::get('markettyps/index', 'MarketTypController@index')->name('markettypsindex');
            Route::get('markettyps/edit/{id}', 'MarketTypController@edit')->name('markettyps.edit');
            Route::get('markettyps/destroy/{id}', 'MarketTypController@destroy')->name('markettyps.destroy');
            Route::post('markettyps/featured', 'MarketTypController@updateFeatured')->name('markettyps.featured');
            Route::post('markettyps/active', 'MarketTypController@updateActive')->name('markettyps.active');
        });

         Route::group(['prefix' => 'categoriesdep', 'as' => 'categoriesdep.','middleware'=>['module:user_section']], function () {
            Route::get('index', 'CategoryDepController@index')->name('create');
            Route::get('create', 'CategoryDepController@create')->name('create');
            Route::get('store', 'CategoryDepController@store')->name('categoriesdep.store');
            Route::get('edit/{id}', 'CategoryDepController@edit')->name('categoriesdep.edit');
            Route::get('destroy/{id}', 'CategoryDepController@destroy')->name('categoriesdep.destroy');
            Route::post('featured', 'CategoryDepController@updateFeatured')->name('categoriesdep.featured');
            Route::post('active', 'CategoryDepController@updateActive')->name('categoriesdep.active');
...
//                Route::get('app', 'LanguageController@index_app')->name('index-app');
        ...
        Route::group(['prefix' => 'branches', 'as' => 'branches.'], function () {
            ...
            Route::post('update/{id}', 'BrancheController@update')->name('update');

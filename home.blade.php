...
@push('css_or_js')
    <meta property="og:image" content="{{asset('storage/public/company')}}/{{$web_config['web_logo']->value}}"/>
    <meta property="og:title" content="Welcome To {{$web_config['name']->value}} Home"/>
    <meta property="og:url" content="{{env('APP_URL')}}">
    <meta property="og:description" content="{!! substr($web_config['about']->value,0,100) !!}">

    <meta property="twitter:card" content="{{asset('storage/public/company')}}/{{$web_config['web_logo']->value}}"/>
                        ...
                        <a href="{{route('products',['id'=> $brand['id'],'data_from'=>'brand','page'=>1])}}">
                            <div class="d-flex align-items-center justify-content-center"
                                ...
                                <img style="border-radius: 50%;"
                                    ...
                                    src="{{asset("storage/public/brand/$brand->image")}}" alt="{{$brand->name}}">
                            </div>
                        </a>
                    </div>
                @endforeach
            ...
            <div class="col-12 pl-0 pr-0">
                <a href="{{$main_section_banner->url}}"
                    ...
                    <img class="d-block footer_banner_img" style="width: 100%;border-radius: 5px;height: auto !important;"
                            onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                            src="{{asset('storage/public/banner')}}/{{$main_section_banner['photo']}}">
                </a>
            </div>
        </div>
    </div>
                                            ...
                                            <center>
                                                <a href="{{route('shopView',['id'=>$seller['id']])}}">
                                                    <img
                                                        ...
                                                        onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                                                        src="{{asset("storage/public/shop")}}/{{$seller->shop->image}}">
                    ...
                    <a href="{{$banner->url}}"
                        style="cursor: pointer;">
                         <img class="" style="width: 100%; border-radius:5px;height:auto;"
                              onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                              src="{{asset('storage/public/banner')}}/{{$banner['photo']}}">
                     </a>
                </div>
            @endforeach
        </div>
